...
def format_pesos(valor):
    return f"${valor:,.0f}"  # Usar f-string para formatear con comas
...
def load_data():
    ...
    data_deporte = {
        ...
        "Inscritos": [200, 150, 80, 50, 120, 60, 250] # Datos de ejemplo, reemplazar con datos reales
    }
    ...
    data_inclusion_social = {
        ...
        "Participantes": [30, 50, 20, 15] # Datos de ejemplo, reemplazar con datos reales
    }
...
if seccion == "Inicio":
    ...
    st.image("https://www.munidonihue.cl/wp-content/uploads/2020/12/cropped-Logo_Doñihue-300x138.png", 
             use_column_width=True, caption="Doñihue: Tradición y Progreso")
...
# Sección de Sesiones y Reuniones
elif seccion == "Sesiones y Reuniones":
    st.header("Sesiones y Reuniones 2023: Un Concejo Municipal Activo")
    fig = px.bar(
        data["sesiones"], 
        x="Tipo de Sesión", 
        y="Cantidad", 
        color="Tipo de Sesión", 
        title="Sesiones y Reuniones 2023",
        color_discrete_sequence=COLOR_PALETTE
    )
    fig.update_layout(xaxis_title="", yaxis_title="Cantidad de Sesiones")
    st.plotly_chart(fig)

    st.write("""
    El gráfico muestra la cantidad de sesiones ordinarias, extraordinarias y reuniones de comisión 
    realizadas durante el 2023. Este trabajo constante del Concejo Municipal refleja su compromiso 
    con la toma de decisiones informada y la gestión transparente.
    """)
...
# Sección de Mejoras Tecnológicas
...
# Sección de Infraestructura Educativa
...
# Sección de Beneficios Sociales
...
# Sección de Evolución de Usuarios de Salud
...
# Sección de Proyectos
    ...
    if selected_area == "Todos":
        ...
        filtered_proyectos = data["proyectos"][data["proyectos"]["Área"] == selected_area]
    ...
    # Mapa 3D de Proyectos (CORREGIDO)
